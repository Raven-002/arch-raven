...
yes_no_prompt "Install zsh config?" && "$INSTALLER_DIR/install/install-zsh-condig.zsh"
yes_no_prompt "Install kitty config?" && "$INSTALLER_DIR/install/install-kitty-condig.zsh"
